    ...
    if (isAdmin) {
        content = (
            <div className='flex flex-col justify-center mx-auto  gap-2 py-10 px-10'>
                ...
                <NavLink className="bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 p-3 text-white rounded-xl " to="/dashboard/balance">Balance</NavLink>
    ...
    return (
        <div className='bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500'>
            <div className=' mx-auto md:flex'>
                <div className='md:w-96 md:min-h-screen bg-white '>
                    {content}
                </div>
